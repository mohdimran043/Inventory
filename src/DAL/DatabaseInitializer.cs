    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "P@ssw0rd", "Inbuilt Administrator", "admin@moi.com", "+97470645828", new string[] { adminRoleName });
                await CreateUserAsync("user", "P@ssw0rd", "Inbuilt Standard User", "user@moi.com", "+97470645828", new string[] { userRoleName });
